...
const Layout: React.FC<LayoutProps> = ({ children, onNavigateHome, showHomeButton }) => {
  ...
  const textSizeLabel =
    textSize === 0 ? 'Aumentar tamaño de texto' :
    textSize === 1 ? 'Aumentar a tamaño muy grande' :
    'Volver a tamaño normal';

  return (
    <div className={`min-h-screen flex flex-col bg-[#372523] text-[#DAD9D5] ${textSizeClass}`}>
